...
## Важные фиксы
### v1.20.14 — Хоткеи 1–9
- Клавиши **1–9** кликают соответствующий результат в панели (1 = первый)
- На каждом результате синий бейдж с номером
- Игнорируется при вводе текста в поля/автокомплит (в т.ч. shadow DOM input)
- Работает только когда скрипт включён
