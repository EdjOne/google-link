        ...
        try {
            ...
            tabPane.innerHTML = `
                <div style="padding:10px;">
                    <h3 style="margin:0 0 8px 0;">🔍 Google Link <small style="font-weight:normal;color:#aaa;">v1.13.0</small></h3>
            ...
            if (s?.ids?.length === 1) {
                ...
                if (t === 'venue') {
                    try {
                        ...
                        // Skip address points (RPP/AT): residential, placeholder, or non-POI entityType
